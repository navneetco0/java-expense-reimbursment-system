...
/**
 * Expense Section Report
 */
public class ExpenseSectionReport extends JFrame {
    ...
    private void Connect() {
        try {
            ...
            Logger.getLogger(ExpenseSectionReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private void initComponents() {
        setTitle("Expense Section Report");
        getContentPane().setLayout(new BorderLayout());

        jLabel1 = new JLabel("Expense Report");
        ...
        jLabel2 = new JLabel("<html>This report displays all expense categories and claims in the system.</html>");
        ...
        jTextArea1.setText("Expense Report:\n\nNo data loaded yet.\nClick 'Generate Report' to load expense data.");
    ...
    private void generateReport() {
        try {
            ...
            report.append("========== EXPENSE SECTION REPORT ==========\n\n");
            
            String sql = "SELECT * FROM expensecategory";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();

            report.append(String.format("%-10s %-25s %-15s%n", "Category ID", "Category Name", "Description"));
            ...
            report.append("Total Categories: ").append(count).append("\n");
